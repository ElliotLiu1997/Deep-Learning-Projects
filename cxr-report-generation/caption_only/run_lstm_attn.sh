...
OUT_DIR="${PROJECT_ROOT}/caption_only/outputs/lstm_attn"
GPU_IDS="0,1"
...
echo "[lstm_attn] train -> ${OUT_DIR}"
python -m caption_only.train \
  --decoder_type lstm_attn \
  --data_csv "${DATA_CSV}" \
  --image_dir "${IMAGE_DIR}" \
