...
def _build_test_loader(cfg, vocab: Vocabulary, use_feature_cache: bool):
    ...
    test_ds = Flickr8kCaptionDataset(
        ...
        feature_npy_path=cfg.features_test_path if use_feature_cache else None,
        feature_keys_json_path=cfg.feature_keys_test_path if use_feature_cache else None,
...
def evaluate_variant(cfg, vocab: Vocabulary, variant: str):
    ...
    test_ds, _test_dl = _build_test_loader(cfg, vocab, use_feature_cache=use_feature_cache)
    ...
    for image_name in pbar:
        ...
        pred_tokens = _generate_for_image(model, feature_or_image, use_feature_cache, cfg, vocab)
